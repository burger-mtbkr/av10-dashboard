import { SOURCE_MAP, SMART_SELECT_DEFAULTS, SMART_SELECT_SLOTS } from '../../core/constants.js';
import type { IInputSource, ISmartSelectPreset } from '../../types/core.js';
import type { IHttpStatusResult } from '../../types/api.js';
import {
  fetchAppCommand0300,
  fetchMainZoneStatus,
  fetchSpeakerPreset,
...
import { fetchHeosQuickSelectNames } from '../heos/index.js';
import {
  parseActiveSpeakers,
  parseAudioInfo,
  parseNetworkInfo,
