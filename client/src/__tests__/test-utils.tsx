...
import type { AVRStatus, SpeakerStatus, VideoInfo, AudioInfo, SubwooferInfo, InputSource } from '../types';
...
export function createMockStatus(overrides: Partial<AVRStatus> = {}): AVRStatus {
  return {
    power: 'ON',
    volume: -35,
